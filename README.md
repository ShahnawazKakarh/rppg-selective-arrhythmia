...
[![Submitted to IEEE JBHI](https://img.shields.io/badge/Submitted-IEEE%20JBHI%202026-orange)](https://ieee.atyponrex.com/journal/jbhi-embs)
...
[![Google Scholar](https://img.shields.io/badge/Google%20Scholar-Profile-4285F4?logo=googlescholar&logoColor=white)](https://scholar.google.com/citations?hl=en&user=_0MpIosAAAAJ)
...
> **Status — v1.9.0, submitted to IEEE JBHI (June 2026).** Manuscript is under editorial consideration at the [IEEE Journal of Biomedical and Health Informatics](https://www.embs.org/jbhi/). The IEEE-format paper PDF builds reproducibly via GitHub Actions and is the canonical artifact. WeasyPrint version: [`paper/lw-ccsd-rppg-af-v1.9.0.pdf`](paper/lw-ccsd-rppg-af-v1.9.0.pdf). **Zenodo (latest):** [doi.org/10.5281/zenodo.20901698](https://doi.org/10.5281/zenodo.20901698). **SSRN:** [abstract 6971878](https://papers.ssrn.com/abstract=6971878). Indexed on [Google Scholar](https://scholar.google.com/citations?hl=en&user=_0MpIosAAAAJ). Earlier Zenodo snapshots: [v1.2.0](https://doi.org/10.5281/zenodo.20818623), [v1.0.0](https://doi.org/10.5281/zenodo.20776347). v1.9.0 spans 5 UQ methods (deterministic, MC Dropout, deep ensembles, EDL, SNGP) + EDL ensemble + full conformal arc (per-class, Bonferroni, Holm, multivariate-beta). EDL mechanism established at 5 independent levels (empirical, ensembling, conformal, KL annealing schedule, KL→∞ ablation). The KL→∞ ablation refines the mechanism: the no-LW-CCSD-margin property requires KL annealing, not just the Dirichlet head. See [Findings](#findings) and [Roadmap](#roadmap).
